...
A return autocorelation is expected after the event, with a momentum phase, resulting in a positive price increase for a positive private signal, and a negative price increase for a negative price signal:

![expected return autocorrelation](return_autocorrelation.png)
